...
for i, x in enumerate(date_list):
	if i+1-200 >= 0:
		mean_200 = np.mean(price_list[i+1-200:i+1])
		mean_200_list.append(mean_200)
	else:
		mean_200 = np.mean(price_list[:i+1])
		mean_200_list.append(mean_200)
...
plt.plot(date_list, mean_200_list, label='mean_200')
